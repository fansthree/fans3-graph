...
export class Fans3Shares extends ethereum.SmartContract {
  static bind(address: Address): Fans3Shares {
    return new Fans3Shares("Fans3Shares", address);
  }
  ...
  getFansOfSubject(sharesSubject: Address): Array<Address> {
    let result = super.call(
      "getFansOfSubject",
      "getFansOfSubject(address):(address[])",
      [ethereum.Value.fromAddress(sharesSubject)]
    );
